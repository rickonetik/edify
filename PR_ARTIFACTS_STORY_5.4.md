...
_(Вставить скрин: `assets/` или в PR описание.)_
...
_(Вставить скрины в PR или в `assets/`; если уже делал раньше — достаточно проверить, что `/account?expertCta=none` без Pro.)_
